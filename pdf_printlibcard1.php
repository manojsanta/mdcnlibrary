...
<tr><td align="center" colspan="3"><h4>LIBRARY CARD CUM STUDENT PASSBOOOK</h4></td></tr>
<tr>
...
$output .= '<table width="100%" height="100%"><tr valigh="top"><td width="25%" valign="top"><table width="100%" cellspacing="0">



<tr><th>Name of the Student</th></tr>
<tr><th>' . strtoupper($row1['fullname']) . '</th></tr>
<tr><th>College Roll No.</th></tr>
<tr><th>' . strtoupper($row1['school_number']) . '</th></tr>
<tr><th>Honours Department</th></tr>
<tr><th>' . $row1['subject'] . '</td></tr>
<tr><th>Academic Session</th></tr>
<tr><th>' .  $row1['admyear'] . "-" . $row1['sessionend']  . '</td></tr>
...
<table width="100%">
<tr >
<td> Date:' . date("d-m-Y", strtotime($row2['issuedate'])) . '</td>
<td>Librarin Sign.</td>
</tr>
</table>
</td>
