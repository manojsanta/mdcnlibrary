...
if (strlen($_SESSION['sid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($row > 0) {
            echo "<script>alert('Roll Number already exist!'); window.location='patron_list.php'</script>";
        } else {
            ...
            echo "<script>alert('Student successfully added!'); window.location='patron_list.php'</script>";
        }
    }
}
                            ...
                            <form role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="names">Hons Subject</label>
