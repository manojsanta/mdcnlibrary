            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Books Barcode Print</h4>
                        <div>
                            ...
                            <a href="pdf_printbarcode.php" target="_blank" style="background:none;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-4" id="dvContents">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $dyn_table = '<table border="0" cellpadding="10"  cellspacing="12" width="100%" >';
