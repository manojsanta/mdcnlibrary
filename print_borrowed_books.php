...
<body>
    <div class="container">
        <div id="header">
            <br />
            <img src="images/weblogo.png" style=" margin-top:-12px; float:left; margin-left:115px; margin-bottom:-6px; width:100px; height:100px;">
            <img src="images/weblogo.png" style=" margin-top:-12px; float:right; margin-right:115px; width:100px; height:100px;">
            <center>
                <h5 style="font-style:Calibri"></h5>&nbsp; &nbsp;&nbsp; MODEL DEGREE COLLEGE,NAYAGARH &nbsp; &nbsp;
            </center>
            <center>
                <h5 style="font-style:Calibri; margin-top:-12px;"></h5> &nbsp; &nbsp; Library Management System
            </center>
            <center>
                <h5 style="font-style:Calibri; margin-top:-12px;"></h5> Lathipada,Nayagarh-752079
            </center>

            <button type="submit" id="print" onclick="printPage()">Print</button>
            <p style="margin-left:30px; margin-top:30px; font-size:14pt; font-weight:bold;">Borrowed Books Information</p>
            <div align="right">
            ...
            $return_query = mysqli_query($con, "SELECT * from borrow_book
							...
							where borrow_book.borrowed_status = 'borrowed'  order by borrow_book.borrow_book_id DESC") or die(mysqli_error($con));
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['fullname']; ?></td>
                            <td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['type']; ?></td>
                            <td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['book_title']; ?></td>
                            <td style="text-transform: capitalize; text-align:center;"><?php echo $return_row['subject']; ?></td>
            ...
            <?php
            include('includes/dbconnection.php');
            $user_query = mysqli_query($con, "select * from admin where admin_id=" . $_SESSION['sid'] . "") or die(mysqli_error($con));
            $row = mysqli_fetch_array($user_query); {
            ?> <h2><i class="glyphicon glyphicon-user"></i> <?php echo '<span style="color:blue; font-size:15px;">Prepared by:' . $row['firstname'] . " " . $row['lastname'] . " " . '</span>'; ?></h2>
            <?php } ?>
