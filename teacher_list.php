            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Techer</h4>
                        <div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display text-dark">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysqli_query($con, "SELECT * from user where status='Active' and type='Teacher' order by user_id desc") or die(mysqli_error($con));
