            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Patrons</h4>
                        <div>
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="add_patron.php"><i class="fa fa-plus color-info"></i>
                                        New Student</a>
                                    <a class="dropdown-item" href="add_teacher.php"><i class="fa fa-plus color-info"></i>
                                        New Faculty</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example" class="display text-dark">
                                ...
                                <tbody>
                                    <?php
                                    $result = mysqli_query($con, "SELECT * from user where status='Active' and type='Student' order by user_id desc") or die(mysqli_error($con));
