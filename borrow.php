            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Borrow Books/Materials</h4>
                        <a href="borrowt.php" class="btn btn-primary"><i class="fa fa-level-up" aria-hidden="true"></i> Borrow to Staff/Teacher</a>
                    </div>
                    <div class="card-body">
