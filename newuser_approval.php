...
if (isset($_POST['update'])) {
    ...
    mysqli_query($con, "UPDATE user SET status='Active' WHERE user_id='$id'") or die(mysqli_error($con));
    mysqli_query($con, "INSERT into libcard(libcardno,rollno,issuedate) values ('$libcard','$schoolnumber','$stdob')") or die(mysqli_error($con));
    echo "<script>alert('Student Arroved to Library successfully...');</script>";
    echo "<script>window.location.href ='newuser_approval.php'</script>";
}
if (isset($_POST['delete'])) {
    ...
    $stdob = $_POST['stdob'];
    $libcard = $_POST['libcard'];
    $schoolnumber = "REJ" . $_POST['schoolnumber'];
    mysqli_query($con, "UPDATE user SET status='Reject',school_number='$schoolnumber' WHERE user_id='$id'") or die(mysqli_error($con));
    // mysqli_query($con, "INSERT into libcard(libcardno,rollno,issuedate) values ('$libcard','$schoolnumber','$stdob')") or die(mysqli_error($con));
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Manage Patron's Approval</h4>
                        <div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table id="example" class="display text-dark table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $sqlclearance = "SELECT *  from user WHERE status='Pending' order BY user_added desc";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo date('d-m-Y', strtotime($row['user_added'])); ?></td>
                                            <td>

                                                <a class="btn btn-success btn-sm" for="ViewAdmin" href="#view<?php echo $row['user_id']; ?>" data-toggle="modal">
                                                    <i class="fa fa-check" aria-hidden="true"></i>
                                                </a>
                                                <a class="btn btn-danger btn-sm" for="ViewAdmin" href="#delete<?php echo $row['user_id']; ?>" data-toggle="modal">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="basic-form">
                                                                    <h5 class="text-danger offset-md-1">Approval Remarks</h5>
                                                                    <form method="post" action="">
                                                                        <input type="hidden" name="roll" value="<?php echo $row['user_id']; ?>">
                                                                        <input type="hidden" name="libcard" value="<?php echo $row['libcardno']; ?>">
                                                                        <input type="hidden" name="schoolnumber" value="<?php echo $row['school_number']; ?>">
                                                                        <div class="form-row">
                                                ...
                                                <!-- delete modal -->
                                                <div class="modal fade" data-backdrop="static" id="delete<?php echo $row['user_id']; ?>">
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Member
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="basic-form">
                                                                    <h5 class="text-danger offset-md-1">Rejection Remarks</h5>
                                                                    <form method="post" action="">
                                                                        <input type="hidden" name="roll" value="<?php echo $row['user_id']; ?>">
                                                                        <input type="hidden" name="libcard" value="<?php echo $row['libcardno']; ?>">
                                                                        <input type="text" name="schoolnumber" value="<?php echo $row['school_number']; ?>">
                                                                        <div class="form-row">
